...
import Foundation
import AETextViewThirdPartyInternal

public typealias TSYTextStorage = AETextViewThirdPartyInternal.TSYTextStorage
public typealias TSYTextStorageDelegate = AETextViewThirdPartyInternal.TSYTextStorageDelegate
